...
(function ($, window, document) {
    ...
    var Slider = {
        ...
        css2move : function (value) {
            var base = this;
            base.$BTQWrapper.css({"left" : value});
        },
        ...
        disabledEvents :  function () {
            var base = this;
            base.$elem.on("dragstart.BTQ", function (event) { event.preventDefault(); });
        ...
        stopOnHover : function () {
			...
			var Hover = $('.view-details, .nav li a, .item-sub a,.all-sub, .home-content,.zoom, .pro-pic-left');
