<?php
/**
 * Melosa Customizer functionality
 *
 * @package WordPress
 * @subpackage Melosa
 * @since Melosa 1.0
...
/**
 * Register color schemes for Melosa.
 *
...
/**
 * Get the current Melosa color scheme.
 *
 * @since Melosa 1.0
 *
...
/**
 * Returns an array of color scheme choices registered for Melosa.
 *
 * @since Melosa 1.0
 *
